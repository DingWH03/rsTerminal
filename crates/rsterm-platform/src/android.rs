...
use crate::Platform;
use crate::process;
use crate::serial::{self, SerialDevice};
...
pub(super) fn init(app: &winit::platform::android::activity::AndroidApp) {
    ...
    crate::android_ime::init(app.clone());
    crate::android_storage::ensure_storage_access(app);
    crate::android_storage::ensure_bluetooth_access(app);
    crate::android_btleplug::cache_class_loader_from_activity(app);
    crate::android_btleplug::init_from_android_app(app.vm_as_ptr());
...
impl Platform for AndroidPlatform {
    ...
    fn scan_ble_devices(&self) -> Result<Vec<String>, String> {
        ...
        if let Err(e) = crate::android_btleplug::ensure_initialized() {
            return Err(e);
        }
        crate::ble::scan_ble_devices_blocking()
    }
