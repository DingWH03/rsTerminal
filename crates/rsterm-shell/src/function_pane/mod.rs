...
impl FunctionPane {
    ...
    pub fn hamburger(&mut self, ui: &mut egui::Ui) -> egui::Response {
        ...
        if ui.is_rect_visible(rect) {
            crate::uiframe::vector_icons::paint(
                ui,
                rect,
                crate::uiframe::vector_icons::Icon::Hamburger,
...
pub fn render(
    ...
    let active_tip = crate::i18n_bridge::tr("sidebar_tab_active");
    let conn_tip = crate::i18n_bridge::tr("sidebar_tab_connections");
    let cmds_tip = crate::i18n_bridge::tr("sidebar_tab_commands");
    let files_tip = crate::i18n_bridge::tr("sidebar_tab_files");
    let monitor_tip = crate::i18n_bridge::tr("sidebar_tab_monitor");
