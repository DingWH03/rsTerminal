...
pub fn render(
    ...
    let Some(id) = focused_session_id else {
        paint_empty(
            ui,
            Icon::Chart,
            &crate::i18n_bridge::tr("sidebar_monitor_no_terminal"),
            Some(&crate::i18n_bridge::tr("sidebar_monitor_no_terminal_hint")),
        );
    ...
    if term.core.conn_type != ConnectionType::Ssh {
        paint_empty(
            ui,
            Icon::Chart,
            &crate::i18n_bridge::tr("sidebar_monitor_ssh_only"),
            Some(&crate::i18n_bridge::tr("sidebar_monitor_ssh_only_hint")),
        );
        return FunctionAction::empty();
    }
    ...
    if history.is_empty() {
        paint_empty(
            ui,
            Icon::Chart,
            &crate::i18n_bridge::tr("sidebar_monitor_waiting"),
            Some(&crate::i18n_bridge::tr("sidebar_monitor_waiting_hint")),
        );
        ui.ctx()
        ...
        .show(ui, |ui| {
            ...
            let uptime_label = snap
                ...
                .map(|secs| {
                    ...
                    crate::i18n_bridge::tr_args("sidebar_monitor_uptime", &[("time", &formatted)])
                })
                .unwrap_or_else(|| crate::i18n_bridge::tr("sidebar_monitor_uptime_unknown"));
            ...
            let cpu_title = crate::i18n_bridge::tr("sidebar_monitor_cpu");
            let mem_title = crate::i18n_bridge::tr("sidebar_monitor_mem");
            let disk_title = crate::i18n_bridge::tr("sidebar_monitor_disk");
