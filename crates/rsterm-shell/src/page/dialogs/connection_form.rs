...
impl NewConnectionDialog {
    ...
    fn available_types() -> Vec<ConnectionType> {
        ...
        if rsterm_platform::get().supports_local_terminal() {
        ...
        if rsterm_platform::get().supports_serial() {
            types.push(ConnectionType::Serial);
        }
        if rsterm_platform::get().supports_ble() {
    ...
    pub fn show(
        ...
        let title = if self.edit_id.is_some() {
            crate::i18n_bridge::tr("dialog_edit_connection")
        } else {
            crate::i18n_bridge::tr("dialog_new_connection")
        };
    ...
    fn paint_form(
        ...
        form::labeled_row(ui, crate::i18n_bridge::tr("dialog_type"), |ui| {
        ...
        let selected_profile_label = self
            ...
            .unwrap_or_else(|| {
                format!(
                    "{} ({})",
                    crate::i18n_bridge::tr("dialog_profile_default"),
        ...
        form::labeled_combo(
            ui,
            "conn_profile_combo",
            crate::i18n_bridge::tr("dialog_profile"),
            selected_profile_label,
            |ui| {
                if ui
                    .selectable_label(false, crate::i18n_bridge::tr("dialog_profile_new"))
                    .clicked()
                {
        ...
        match self.conn_type {
            ...
            ConnectionType::Ssh => {
                ...
                let selected_auth_label = self
                    ...
                    .unwrap_or_else(|| crate::i18n_bridge::tr("dialog_auth_user_none"));
                form::labeled_combo(
                    ui,
                    "ssh_auth_user_combo",
                    crate::i18n_bridge::tr("dialog_auth_user"),
                    selected_auth_label,
                    |ui| {
                        if ui
                            .selectable_label(false, crate::i18n_bridge::tr("dialog_auth_user_new"))
                            .clicked()
                        {
                ...
                if auth_users.is_empty() {
                    ui.label(
                        egui::RichText::new(crate::i18n_bridge::tr("dialog_auth_user_hint"))
                            .small()
                            .weak(),
                    );
                }
            ...
            ConnectionType::Ble => {
                let scan_label = if self.ble_scanning {
                    crate::i18n_bridge::tr("scanning")
                } else {
                    crate::i18n_bridge::tr("dialog_scan_devices")
                };
                if ui
        ...
        if matches!(self.conn_type, ConnectionType::Local | ConnectionType::Ssh) {
            ui.add_space(form::SECTION_GAP);
            ui.separator();
            form::section_header(ui, crate::i18n_bridge::tr("dialog_env_vars"));
        ...
        let save_label = if self.edit_id.is_some() {
            ...
            crate::i18n_bridge::tr("create")
        };
        match form::dialog_footer(ui, crate::i18n_bridge::tr("cancel"), save_label, can_create) {
    ...
    fn start_ble_scan(&mut self, ctx: &egui::Context) {
        ...
        #[cfg(target_os = "android")]
        {
            ...
            if !rsterm_platform::get().has_bluetooth_access() {
                rsterm_platform::get().request_bluetooth_access();
