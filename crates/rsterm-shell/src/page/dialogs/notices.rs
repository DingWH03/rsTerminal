...
pub fn paint_quit_confirm(ctx: &egui::Context, open: &mut bool, session_count: usize) -> bool {
    ...
    egui::Window::new(crate::i18n_bridge::tr("quit_with_sessions_title").as_str())
        ...
        .show(ctx, |ui| {
            ...
            let count = session_count.to_string();
            ui.label(
                egui::RichText::new(crate::i18n_bridge::tr_args(
            ...
            ui.horizontal(|ui| {
                let cancel_btn = egui::Button::new(
                    egui::RichText::new(crate::i18n_bridge::tr("cancel"))
                        .size(tokens::text::EMPHASIS)
                ...
                let confirm_btn = egui::Button::new(
                    egui::RichText::new(crate::i18n_bridge::tr("quit_with_sessions_confirm"))
                        .size(tokens::text::EMPHASIS)
                        .strong()
...
pub fn paint_connection_notice(ctx: &egui::Context, notice: &mut Option<String>) {
    ...
    egui::Window::new(crate::i18n_bridge::tr("connection_failed").as_str())
