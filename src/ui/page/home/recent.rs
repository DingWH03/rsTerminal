...
pub fn recent_connections_view(
    ...
    let title = rust_i18n::t!("recent_connections");
    ...
    if recent.is_empty() {
        empty_state::paint_empty_state(
            ...
            EmptyStateConfig::compact(
                Icon::Connections,
                &rust_i18n::t!("home_no_connections"),
                Some(&rust_i18n::t!("open_terminal_hint")),
            ),
        );
        return;
    }
    ...
    egui::ScrollArea::vertical()
        ...
        .show(ui, |ui| {
            ...
            for conn in recent {
                let subtitle = crate::ui::page::home::conn_subtitle(conn);
